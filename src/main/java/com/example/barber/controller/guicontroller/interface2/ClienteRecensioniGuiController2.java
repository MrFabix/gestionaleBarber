...
import com.example.barber.controller.guicontroller.interface2.item2.RecensioneItemGuiController;
...
public class ClienteRecensioniGuiController2  implements Observer, Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            recensioneAppController.addToListClient(this, Session.getInstance().getUser().getId());
        } catch (Exception e) {
    ...
    public void update(Object ob) {
        ...
        if (ob instanceof RecensioneBean bean) {
            try {
                ...
                pane = fxmlLoader.load(Objects.requireNonNull(getClass().getResource("/view/interface2/RecensioneItem.fxml")).openStream());
                RecensioneItemGuiController controller = fxmlLoader.getController();
                controller.setRecensioneDetails(recensioneBean1);
