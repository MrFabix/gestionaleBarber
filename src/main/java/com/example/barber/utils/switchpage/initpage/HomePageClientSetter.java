...
public class HomePageClientSetter {
    public void setter(RequestAppointmentsBean requestAppointmentsBean, BookingFormAppController bookingFormAppController, PageManageUserAppointmentsGuiController pageManageUserAppointmentsGuiController) {
        System.out.println("Sei nel setter home page client setter");
        pageManageUserAppointmentsGuiController.setAll(requestAppointmentsBean, bookingFormAppController);
    }
}
