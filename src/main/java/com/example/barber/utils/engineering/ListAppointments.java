...
public class ListAppointments {
    public List<RequestAppointmentsBean> getAllAppointments(int idUser, StatoRichieste stato) throws SystemException{
        ...
        list = requestAppointmentsDAO.getAllRequestAppointments(idUser,stato);
